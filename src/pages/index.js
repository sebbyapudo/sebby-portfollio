...
export default function Home() {
  return (
    <>
      <Head>
        <title>Sebby Apudo Portfolio</title>
        ...
        <Layout className='pt-0 md:pt-16 sm:pt-8'>
          <div className='flex items-center justify-between w-full lg:flex-col'>
            <div className='w-1/2 md:w-full'>
              <Image src={ProfilePic} alt="Sebby" className='w-full h-auto lg:hidden md:inline-block md:w-full' priority
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              ...
              <p className='my-4 text-base font-medium md:text-sm sm:text-xs'>My name is <em className='underline'>Sebby</em>. I am freelance creative developer, 3D Animator and graphics designer.
              ...
              <div className='flex items-center self-start mt-2 lg:self-center'>
                <Link href="/Sebby-cv.pdf" target={'_blank'} className='flex items-center bg-dark text-light p-2.5 px-6 rounded-lg text-lg font-semibold hover:bg-light hover:text-dark border-2 border-solid border-transparent hover:border-dark dark:bg-light dark:text-dark
